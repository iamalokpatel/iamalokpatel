          ...
          <ResumeCard
            ...
            des={
              <>
                ...
                MongoDB with user auth, and property listings. Focused <br />
                on responsive UI and smooth UX similar to Airbnb.
              </>
            }
          />
        </div>
      ...
      <div>
        ...
        <div className="mt-6 lgl:mt-14 w-full h-auto border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            des={
              <>
                Built a Todo App using Next.js, Express.js, and MongoDB <br />
                with task add, update, and delete features. Focused on
                responsive UI and smooth front–back integration.
              </>
            }
          />
        </div>
